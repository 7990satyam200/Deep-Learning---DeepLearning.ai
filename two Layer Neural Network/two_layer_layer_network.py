...
### testing our classifier on our sample cat image
fname = "my_image2.jpg"
my_label_y=[1]
...
plt.imshow(image)
plt.show()
print ("y = " + str(np.squeeze(my_predicted_image)) + ", your two-layer model predicts a \"" + classes[int(np.squeeze(my_predicted_image)),].decode("utf-8") +  "\" picture.")
